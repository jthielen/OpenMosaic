...
"""Base class(es) for defining file/URL patterns for OpenMosaic, modeled after pangeo-forge.
...
TODO:
    ...
    - audit this code and keep only what makes sense in the generalized OpenMosaic context
      (e.g., we want file patterns not just for aligned/merging things, but general file sets
      for radar and/or analysis and/or sounding data)
"""
...
from ..core.serialization import dataclass_sha256, dict_drop_empty, dict_to_sha256
